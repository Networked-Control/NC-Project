function [K,rho,feas]=LMI_DT_Circle_Area(F,G,H,N,ContStruc,center,radius)
...
LMIconstr=[[(radius^2-center^2)*P-F*P*F'-G*L*F'-F*L'*G'-center*(P*F'+L'*G'+G*L+F*P)     G*L;
                            L'*G'                                         P     ]>=-1e-2*eye(2*ntot)];
