function [K,rho,feas]=LMI_Circle_Area(A,B,C,N,ContStruc,center,radius)
...
LMIconstr=[[(radius^2 - center^2)*Y-center*(Y*A'+A*Y+Btot*L+L'*Btot')     A*Y+Btot*L;
                            (A*Y+Btot*L)'                                         Y     ]>=-1e-2*eye(2*ntot)];
